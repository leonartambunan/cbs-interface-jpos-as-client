...
public class IsoConstants {
    ...
    static class ProcessingCode {
        public final static String INQUIRY = "490000";
        public final static String PAYMENT = "491000";
    }
    ...
    static class ResponseCode {
        ...
        public static final String RC_LIMIT_AMOUNT_WIDTHRAWAL = "61";//Exceeds withdrawal amount limit, melebihi batas jumlah penarikan
